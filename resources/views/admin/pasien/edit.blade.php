...
<div id="content">
  ...
  <div class="container-fluid">
    <h1 class="h3 mb-3 text-gray-800">Edit Pasien</h1>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('admin.pasien.update', $pasien->id) }}">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $pasien->email) }}">
            @error('email')
            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
            @enderror
          </div>
